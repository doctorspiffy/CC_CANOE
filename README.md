...
**Versions:**
- CC2024-ALL-RP.zip - Contains a wholly new implementation that fixes the performance previous performance problem. This new version now supports Unity's Built-in Rendering Pipeline, Universal Rendering Pipeline, and the High Definition Rendering Pipeline. Read CCInstructions2024.pdf above for details. This version also adds Space Mouse support.
